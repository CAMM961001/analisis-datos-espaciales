...
En este caso, al evaluar si el residuo de la suma cuando se divide entre 2 es igual a cero, el resultado fue falso, lo cual indica que el número de cruces es impar y por tanto, el punto de interés se encuentra dentro del polígono.